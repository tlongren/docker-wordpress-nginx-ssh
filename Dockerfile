...
# Basic Requirements
RUN apt-get -y install memcached mysql-server-5.5 mysql-client-5.5 nginx php5-fpm php5-mysql php-apc pwgen python-setuptools curl git unzip openssh-server openssl
